...
return new class extends Migration
{
    ...
    {
        Schema::create('emp_salary_log', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('salary_id');
            $table->foreign('salary_id')->references('id')->on('salary');
            $table->integer('sal_emp_id');
            $table->string('sal_emp_code')->nullable();
            $table->date('sal_emp_doj')->nullable();
            ...
            $table->datetime('sal_add_date')->nullable();
    ...
    {
        Schema::dropIfExists('_emp_salary_log');
    }
};
