...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        $roles = Role::select('id', 'role_name', 'fullname')->where('role_name', '!=', '')->where('role_name', '!=', 'employee')->orderBy('id', 'desc')->get();
    ...
    public function edit(string $id)
    {
        $user = user::find($id);
        $departments = Department::orderBy('id', 'desc')->get();
        $roles = Role::where('role_name', '!=', '')->where('role_name', '!=', 'employee')->orderBy('id', 'desc')->get();
        $companys = Company::orderBy('id', 'desc')->get();
        return view('hr.user.edit-user', compact('user', 'departments', 'roles', 'companys'));
    }
