...
class ProjectController extends Controller
{
    public function index(){
        ...
        ->paginate(10);
            // dd($projects);
        return view("hr.workOrder.project-list",compact('projects'));
    }
    ...
    public function woReport(Request $request){
        ...
        $workOrder='';
        $woReport = WorkOrder::selectRaw('project_id,wo_number,wo_project_coordinator, wo_start_date,wo_end_date,wo_amount')
        ->with(['project.organizations'])
