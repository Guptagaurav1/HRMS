...
<style>
    ...
    .tab-btn.active {
      ...
      border-radius: 4px;
      box-shadow: 0 2px 6px slategray;
    }
...
@section('contents')
    <div class="dashboard-breadcrumb mb-25">
        ...
        <div>
          <a href="{{route('employee-list')}}"><button class="btn btn-sm btn-primary"> Employee List <i class="fa-solid fa-list"></i></button></a>  
    ...
    <div class="dashboard-breadcrumb mb-25">
        <p>Emp Code<strong>: PSSPL/2024-25/4211 </strong></p>
        <p>Employee Name <strong>: Vaibhav </strong></p>
    </div>
        ...
        <div class="employee-tab">
          ...
          <div class="tab-content active" id="content1">
            <div class="row g-3">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <label class="form-label form-ck">Functional Role<span class="text-danger">*</span></label>
                        <select id="inputState" class="form-select form-control">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <label for="formFileSm" class="form-label">Upload Resume <button type="button" class="border-0 bg-transparent"> <span> <i class="fa-solid fa-download"></i></span></button></label>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Enter 10th Passing year">
                            </div>
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label class="form-label">Percentage/Grade</label>
                                <input type="number" class="form-control form-control-sm" placeholder="Enter % Grade">
                            </div>
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Enter 12th Passing year">
                            </div>
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label class="form-label">Percentage/Grade</label>
                                <input type="number" class="form-control form-control-sm" placeholder="Enter % Grade">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Enter Persuing  year">
                            </div>
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label class="form-label">Percentage/Grade</label>
                                <input type="number" class="form-control form-control-sm" placeholder="Enter % Grade">
    ...
    <!-- <div class="row" id="tab-1">
        <div class="col-12">
            <div class="panel">
                <div class="panel-header">
                    <h5 class="text-dark text-white">Employee Details</h5>
                </div>
                <div class="panel-body">
                    <div class="row g-3">
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
        ...
        <div class="col-12">
            <div class="panel">
                <div class="panel-header">
                    <h5 class="text-dark text-white">Reporting Details</h5>
                </div>
                <div class="panel-body">
                    <div class="row g-3">
                        <div class="col-sm-12 col-md-6">
