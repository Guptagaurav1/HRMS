    ...
    <div id="tab-1">
        ...
        <div class="tab-content active mt-4" id="content1">
            <form class="emp_details">
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                        ...
                        <input type="date" class="form-control" name="emp_doj"
                            value="{{!empty($recruitment_details->doj) ? $recruitment_details->doj : ''}}" required>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                        ...
                        <input type="email" class="form-control form-control-sm" name="emp_email_first"
                            ...
                            value="{{!empty($recruitment_details->email) ? $recruitment_details->email : ''}}" required>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                ...
                <div class="col-12 d-flex justify-content-end  px-4 py-3">
                ...
                <div class="row g-3">
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                        ...
                        <select name="emp_gender" class="form-select" required>
                            ...
                            <option value="male" {{!empty($recruitment_details->gender) && $recruitment_details->gender
                                == 'male' ? 'selected' : ''}}>Male</option>
                            <option value="female" {{!empty($recruitment_details->gender) &&
                                $recruitment_details->gender == 'female' ? 'selected' : ''}}>Female</option>
                            <option value="others" {{!empty($recruitment_details->gender) &&
                                $recruitment_details->gender == 'others' ? 'selected' : ''}}>Others</option>
                        </select>
                    </div>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                        ...
                        <select class="form-select" name="emp_category" required>
                            ...
                            <option value="general" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_category == 'general' ? 'selected' :
                                ''}}>Un-Reserved</option>
                            <option value="obc" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_category == 'obc' ? 'selected' : ''}}>OBC
                            </option>
                            <option value="sc" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_category == 'sc' ? 'selected' : ''}}>SC/ST
                            </option>
                            <option value="st" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_category == 'st' ? 'selected' : ''}}>PH
                            </option>
                        </select>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                        ...
                        <select name="emp_blood_group" class="form-select">
                            <option value="" selected="" disabled="">Not Specified</option>
                            <option value="a+" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_blood_group == 'a+' ? 'selected' : '' }}>A+
                            </option>
                            <option value="a-" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_blood_group == 'a-' ? 'selected' : '' }}>A-
                            </option>
                            <option value="b+" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_blood_group == 'b+' ? 'selected' : '' }}>B+
                            </option>
                            <option value="b-" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_blood_group == 'b-' ? 'selected' : '' }}>B-
                            </option>
                            <option value="o+" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_blood_group == 'o+' ? 'selected' : '' }}>O+
                            </option>
                            <option value="o-" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_blood_group == 'o-' ? 'selected' : '' }}>O-
                            </option>
                            <option value="ab+" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_blood_group == 'ab+' ? 'selected' : ''
                                }}>AB+</option>
                            <option value="ab-" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_blood_group == 'ab-' ? 'selected' : ''
                                }}>AB-</option>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                        ...
                        <select class="form-select" name="emp_marital_status" required>
                            ...
                            <option value="single" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_marital_status == 'single' ? 'selected' :
                                ''}}>Single</option>
                            <option value="married" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_marital_status == 'married' ? 'selected' :
                                ''}}>Married</option>
                            <option value="widowed" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_marital_status == 'widowed' ? 'selected' :
                                ''}}>Widowed</option>
                            <option value="divorced" {{!empty($recruitment_details->getPersonalDetail) &&
                                $recruitment_details->getPersonalDetail->emp_marital_status == 'divorced' ? 'selected' :
                ...
                <div class="row g-3">
                    <div class="col-xxl-3 col-lg-6 col-sm-6">
                        ...
                        <textarea class="form-control" id="permanent_address" name="emp_permanent_address"
                            placeholder="Enter Permanent Address With State And City" required>{{!empty($recruitment_details->getAddressDetail) ? $recruitment_details->getAddressDetail->emp_permanent_address : ''}}
                        </textarea>
                    </div>
                    <div class="col-xxl-3 col-lg-6 col-sm-6">
                        ...
                        <textarea class="form-control" id="local_address" name="emp_local_address"
                            placeholder="Enter Correspondence Address With State And City">{{!empty($recruitment_details->getAddressDetail) ? $recruitment_details->getAddressDetail->emp_local_address : ''}}
                        </textarea>
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                        ...
                        <select name="bank_id" class="form-select" required>
                            ...
                            <option value="{{$bank->id}}" {{!empty($recruitment_details->getBankDetail) &&
                                $recruitment_details->getBankDetail->bank_id == $bank->id ? 'selected' :
                        ...
                        <div class="row g-3">
                            <div class="col-xxl-3 col-lg-8 col-sm-6">
                                <label for="formFileSm" class="form-label">Select CSV File <span
                                        class="fw-lighter text-sm">(Only CSV file are allowed and max size : 1mb)</span>
                                    <span class="text-danger">
                                        *</span></label>
                                <input name="csv" class="form-control form-control-sm" type="file" accept=".csv"
                                    required>
                                @error('csv')
