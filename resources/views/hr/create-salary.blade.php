        ...
        <div class="col-12">
            <div class="panel">
                <div class="col-md-12 py-3 px-3">
                    <span class="text-danger">All Fields are Mandatory. Those Fields are not in Used Set as 0 (Zero) value</span>
                ...
                <div class="panel-body">
                    <div class="row g-3">
                        <div class="col-xxl-3 col-lg-12 col-sm-6">
                           <a href=""><p>Employee Details (Only shows Salary Structure Status Pending )</p></a>
                        </div>
            ...
            <div class="panel">
                ...
                <div class="card mb-20">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label class="form-label">PF Employee max(1800)<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control form-control-sm">
                            </div>
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                ...
                <div class="panel-body">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <input type="number" class="form-control form-control-sm" placeholder="Accidental Insurance">
                        </div>
                        <div class="col-sm-12 col-md-6">
