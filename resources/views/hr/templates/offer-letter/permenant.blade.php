<div backimg="background.jpg" margin-top="10px" backtop="25mm" backleft="20mm" backright="20mm" backbottom="25mm">
    <div>
    ...
    <p>Date: {{$details->today_date}}&nbsp;<br />
    &nbsp;<br />
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Subject: Offer for the post of {{$details->designation}}&nbsp;<br />
    &nbsp;<br />
    Dear {{$details->candidate_name}},&nbsp;<br />
    &nbsp;<br />
    1. We are pleased to inform you that you have been selected for the post of {{$details->designation}} at {{$details->location}}.&nbsp;<br />
    &nbsp;<br />
    2. The engagement will commence from the date on which you take up our assignment on or before by&nbsp;{{$details->doj}}.&nbsp;<br />
    &nbsp;<br />
    ...
    4. For this engagement and the services rendered you will be paid a Salary of Rs. {{$details->ctc}}/- p.m. as CTC, deducting applicable taxes at source. Your salary shall be processed against the receipt of your attendance sheet duly signed by the authorized signatory (Reporting Official).&nbsp;<br />
    &nbsp;<br />
