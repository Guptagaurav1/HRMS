                                    ...
                                    <div class="row g-3">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-4 text-wrap">
                                                ...
                                                <input name="internal_reference"  id="internal_reference" type="text" class="form-control form-control-sm" placeholder="Internal Reference" value="{{ old('internal_reference',$workOrder->wo_internal_ref_no) }}">
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            Attachment artechment('attachment');
