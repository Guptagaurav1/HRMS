    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel">
                ...
                <form action="{{ route('update-work-order', $workOrder->id) }}" method="post"
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            ...
                                            <select name="organisation" id="organisation" class="form-select"
                                                ...
                                                @foreach ($organization as $key => $organization_data)
                                                    <option value="{{ $organization_data->id }}"
                                                        @if ($organization_data->id == old('organization', $workOrder->project->organizations->id)) selected @endif>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-4">
                                            ...
                                            <input name="wo_number" id="wo_number" type="text"
                                                ...
                                                readonly value="{{ old('wo_number', $workOrder->wo_number) }}">
                                            ...
                                            <select class="form-select" name="state" id="state">
                                                ...
                                                @foreach ($states as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ old('state', $value->id ?? '') == ($workOrder->wo_state ?? null) ? 'selected' : '' }}>
                                                        {{ $value->state }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        @if ($workOrder->wo_attached_file)
                                            <div class="col-sm-12 col-md-4 text-wrap">
                                                ...
                                                <a href="{{ asset('storage/uploadWorkOrder/' . $workOrder->wo_attached_file) }}"
                                                    target="_balnk"
                                                    class="btn btn-primary btn-sm">{{ $workOrder->wo_attached_file }}</a>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="addMoreElement">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-6 text-wrap">
                                                        ...
                                                        <input name="c_designation[{{ $contact->id }}]"
                                                            id="c_designation" type="text"
                                                    ...
                                                    <div class="col-sm-12 col-md-6 text-wrap">
                                                        ...
                                                        <input name="c_contact[{{ $contact->id }}]" id="c_contact"
                                                            type="text" class="form-control form-control-sm"
                                                            placeholder="Contact"
                                                            value="{{ $contact->wo_client_contact }}" maxlength="10"
                                                            oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                                    </div>
                                                    <div class="col-sm-12 col-md-6 text-wrap">
                                                        <label class="form-label text-wrap">Email</label>
                                                        <input name="c_email[{{ $contact->id }}]" id="c_email"
                                                            type="email" class="form-control form-control-sm"
                                                            placeholder="Email" value="{{ $contact->wo_client_email }}">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 text-wrap">
                                                        ...
                                                        <textarea name="c_remarks[{{ $contact->id }}]" id="c_remarks" class="form-control" id="exampleTextarea"
                                                            placeholder="Enter Remarks">{{ $contact->wo_client_remarks }}</textarea>
                                                    </div>
                                                    <div class="col-12 d-flex justify-content-end">
                                                        <button type="button"
                                                            class="btn btn-sm btn-primary mx-3 mt-3 delete-btn">Delete <i
                                        ...
                                        @empty
                                            <div class="addMoreElement">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-sm-12 col-md-6 text-wrap">
                                                        <label class="form-label text-wrap">Contact</label>
                                                        <input name="c_contact[]" id="c_contact" type="text"
                                                            class="form-control form-control-sm" placeholder="Contact" oninput="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="10" minlength="10"
                                                            value="">
                                                    </div>
                                                    <div class="col-sm-12 col-md-6 text-wrap">
                                                        <label class="form-label text-wrap">Email</label>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-sm-12 col-md-12 text-wrap">
                                                        <label for="exampleTextarea" class="form-label">Remarks</label>
                                                        <textarea name="c_remarks[]" id="c_remarks" class="form-control" id="exampleTextarea" placeholder="Enter Remarks"
                                                            value=""></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-12 d-flex justify-content-end">
                        ...
                        <div class="tab-content" id="content4">
                            <div class="panel-body">
                                    ...
                                    <div class="col-sm-12 col-md-4 text-wrap">
                                        ...
                                        <select class="form-select form-control" name="invoice_state" id="state">
                                            ...
                                            @if (!empty($states))
                                                @foreach ($states as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ $workOrder->wo_invoice_state == $value->id ? 'selected' : '' }}>
                                                        {{ $value->state }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        ...
                                        <select class="form-select" id="cities" name="invoice_city">
                                            ...
                                            @if ($invoice_cities)
                                                @foreach ($invoice_cities as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ $workOrder->wo_invoice_city == $value->id ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <div class="col-sm-12 col-md-4 text-wrap">
                                        <label for="exampleTextarea" class="form-label">Address</label>
                                        <textarea name="invoice_address" id="invoice_address" class="form-control" id="exampleTextarea"
                                            placeholder="Enter Address" value="{{ old('invoice_address', $workOrder->wo_invoice_address) }}"></textarea>
                                    </div>
                                </div>
