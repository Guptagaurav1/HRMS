                    ...
                    <form class="row g-3">
                        <div class="col-auto">
                            <input type="search" name="search" class="form-control" value="{{ $search }}"
                                placeholder="Search by added by" required>
                        </div>
                        <div class="col-auto">
                            ...
                            @forelse($report as $key => $value)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-primary hide-text" data-bs-toggle="modal"
                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form compose-email" method="post"
                                                        action="{{ route('send-report-mail') }}">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="container">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=&su={{ urlencode('Check this out') }}&body={{ urlencode('Hey! Check out this awesome content: ' . asset('work-order/wo-report/' . $value->doc)) }}"
                                                                            target="_blank">
                                                                            <button type="button"
                                                                                class="btn btn-success">Share via Gmail
                                                                            </button>
                                                                        </a>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <a href="https://wa.me/?text={{ asset('work-order/wo-report/' . $value->doc) }}"
                                                                            target="_blank">
                                                                            <button type="button"
                                                                                class="btn btn-primary">Share via
                                                                                whatsapp</button>
                                                                        </a>
                                                                    </div>
                                                                </div>
