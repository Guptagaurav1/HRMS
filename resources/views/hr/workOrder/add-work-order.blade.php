                ...
                @if (auth()->user()->hasPermission('work-order-list'))
                    <div class="dashboard-breadcrumb mb-25">
                        ...
                        <div class="col-12 d-flex justify-content-end">
                            <a href="{{ route('work-order-list') }}"><button class="btn btn-sm btn-primary mx-3 mt-3"> Work
                                    Order
                                ...
                                <div class="row g-3">
                                        ...
                                        <select name="organisation" id="organisation" class="form-select form-control"
                                            ...
                                            @foreach ($organization as $key => $organization_data)
                                                <option value="{{ $organization_data->id }}"
                                                    @if ($organization_data->id == old('organization', $project->organisation_id ?? null)) selected @endif>
                                    ...
                                    <div class="col-sm-12 col-md-4 text-wrap">
                                        ...
                                        <input id="project_no" readonly type="text" class="form-control form-control-sm"
                                            ...
                                            value="{{ $project->project_number ?? null }}">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-4 text-wrap">
                                            ...
                                            <textarea name="remarks" class="form-control" id="remarks" placeholder="Enter Remarks if any?"
                                    ...
                                    <div class="addMoreElement">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-4 text-wrap">
                                                ...
                                                <input name="c_contact[]" id="c_contact" type="text" maxlength="10"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-4 text-wrap">
                                        ...
                                        <textarea name="invoice_address" id="invoice_address" class="form-control" id="exampleTextarea"
                                            placeholder="Enter Address" value="{{ old('invoice_address') }}"></textarea>
                                    </div>
                                </div>
