                        ...
                        <div class="row g-3">
                            <div class="row">
                                <div class="col-sm-12 col-md-4">
                                    ...
                                    <select name="organisation_id" id="organisation_id"  class="form-select">
                                        ...
                                        @foreach($organization as $key => $organization_data)
                                            <option value="{{$organization_data->id}}" @if ($organization_data->id == old('organisation_id',$project->organisation_id)) selected @endif >
                                ...
                                <div class="col-sm-12 col-md-4 text-wrap">
                                        ...
                                        <input name="project_number" id="project_number" type="text" class="form-control form-control-sm" placeholder="Enter Project Number" value="{{ old('project_number',$project->project_number) }}">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-4 text-wrap">
                                    ...
                                    <input name="project_name" id="project_name" type="text" class="form-control form-control-sm" placeholder="Project Name" value="{{ old('project_name',$project->project_name) }}">
                                    @error('project_name')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                </div>
                                ...
                                <div class="col-sm-12 col-md-4 text-wrap">
                                    ...
                                    <input name="empanelment_reference" id="empanelment_reference" type="text" class="form-control form-control-sm"
                                        placeholder="Empanelment Reference" value="{{ old('empanelment_reference',$project->empanelment_reference) }}">
