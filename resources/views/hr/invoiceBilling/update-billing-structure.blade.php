...
<div class="row" id="tab-1">
    <div class="col-12">
        <div class="panel">
            ...
            <div class="dashboard-breadcrumb mb-25">
                <p> <strong>Client Name (Organisation) <span> : {{$billingStructure->organizations->name}}
                    </strong></span></p>
                <p><strong>Work Order : <span>{{$billingStructure->wo_number}} </strong></span></p>
            </div>
    ...
    <form action="{{ route('update-billing-structure',$billingStructure->id) }}" method="post">
                ...
                <div class="panel-body">
                    <div class="row g-3">
                        <div class="col-sm-12 col-md-4">
                            ...
                            <input type="text" name="billing_to" id="billing_to"
                                value="{{$billingStructure->billing_to}}" class="form-control"
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            <input type="text" name="billing_address" id="billing_address"
                                value="{{$billingStructure->billing_address}}" class="form-control"
                        ...
                        <div class="col-sm-12 col-md-4">
                            <label class="form-label" for="billing_gst">Billing GSTIN/UIN <span
                                    class="text-danger">**</span></label>
                            <input type="text" name="billing_gst" id="billing_gst"
                                value="{{$billingStructure->billing_gst_no}}" class="form-control"
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            <input type="text" name="billing_state" id="billing_state" class="form-control"
                                value="{{$billingStructure->billing_state}}" placeholder="Enter Biling State">
                            @error('billing_state')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-12 col-md-4">
                            ...
                            <input type="text" name="billing_contact_person" id="billing_contact_person"
                                class="form-control for_char" value="{{$billingStructure->contact_person}}"
                                placeholder="Enter Billing Contact Person Name" required>
                        ...
                        <div class="col-sm-12 col-md-4">
                            <label class="form-label" for="billing_email_id">Billing Email ID <span
                                    class="text-danger">**</span></label>
                            <input type="text" name="billing_email_id" id="billing_email_id" class="form-control for_char"
                                placeholder="Enter Billing Email" value="{{$billingStructure->email_id}}" required>
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            <input type="text" name="billing_code" id="billing_code" class="form-control"
                                placeholder="Enter Billing Code" value="{{$billingStructure->billing_sac_code}}"
                                required>
                            @error('billing_code')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            <select name="billing_tax_mode" id="billing_tax_mode" class="form-select form-control"
                                ...
                                <option value="cgst_sgst" {{ old('billing_tax_mode', $billingStructure->
                                    billing_tax_mode) == 'cgst_sgst' ? 'selected' : '' }}>CGST & SGST</option>
                                <option value="igst" {{ old('billing_tax_mode', $billingStructure->billing_tax_mode) ==
                                    'igst' ? 'selected' : '' }}>IGST</option>
                            </select>
                        ...
                        <div class="col-sm-12 col-md-4">
                            <label class="form-label" for="billing_tax_rate">Billing Tax % <span
                                    class="text-danger">**</span></label>
                            <input type="text" name="billing_tax_rate" id="billing_tax_rate"
                                value="{{$billingStructure->billing_tax_rate}}" class="form-control"
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            <select name="show_service_charge" id="show_service_charge" class="form-select form-control"
                                ...
                                <option value="yes" {{ old('show_service_charge', $billingStructure->
                                    show_service_charge) == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no" {{ old('show_service_charge', $billingStructure->show_service_charge)
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            <input type="text" name="billing_service_rate" id="billing_service_rate"
                                class="form-control" value="{{$billingStructure->service_charge_rate}}"
                                placeholder="Enter Billing Service Charge" required>
        ...
        <div class="col-12 d-flex justify-content-end gap-3 gap-3 mt-3">
            <div>

                <a href="{{ route('biling-structure-list') }}"> <button type="button" class="btn btn-sm btn-secondary"> Cancel
                    </button></a>
            </div>
            <div>
                <button class="btn btn-sm btn-primary"> Update Billing Structure </button>
            </div>
