                ...
                <div class="panel-body">
                    <div class="row g-3">
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            ...
                            <input type="text" class="form-control form-control-sm" name="position_title" value="{{old('position_title')}}" required>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            ...
                            <select  class="form-select" name="employment_type" value="{{old('employment_type')}}" required>
                                <option value="">Select Employement Type</option>
                                <option value="Permenant" {{old('employment_type') == 'Permenant' ? 'selected' : ''}}>Permanent</option>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            ...
                            <input type="number" class="form-control form-control-sm" name="no_of_requirements" value="{{old('no_of_requirements')}}" min="0" required>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            ...
                            <input type="date" name="date_notified" value="{{old('date_notified')}}" class="form-control form-control-sm">
                            @error('date_notified')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="col-xxl-3 col-lg-4 col-sm-6 d-flex flex-wrap">
                            ...
                            <div class="d-flex w-100">
                                <input type="number" class="form-control form-control-sm me-2" name="salary_from" value="{{old('salary_from')}}" placeholder="From" min="0" required>
                                @error('salary_from')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                                <input type="number" class="form-control form-control-sm" name="salary_to" value="{{old('salary_to')}}" placeholder="To" min="0" required>
                                @error('salary_to')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            ...
                            <div class="">
                                <select  class="form-select js-example-basic-multiple" name="functional_role[]" multiple="multiple" required>
                                    ...
                                    <option value="{{$role->id}}" {{old('functional_role') && in_array($role->id, old('functional_role')) ? 'selected' : ''}}>{{$role->role}}</option>
                                    @endforeach
                                </select>
                ...
                <div class="panel-body">
                    <div class="row g-3">
                        <div class="col-xxl-3 col-lg-6 col-sm-6">
                            ...
                            <textarea class="form-control" name="job_description" required>{{old('job_description')}}</textarea>
                ...
                <div class="panel-body">
                    <div class="row g-3">
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            ...
                            <select  class="form-select js-example-basic-multiple" name="education[]" multiple="multiple" required>
                                ...
                                @foreach($qualification as $qualify)
                                    <option value="{{$qualify->id}}" {{old('education') && in_array($qualify->id, old('education')) ? 'selected' : ''}}>{{$qualify->qualification}}</option>
                                 @endforeach
                            </select>
                            @error('education')
                            <span class="text-danger">{{$message}}</span>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6 d-flex flex-wrap">
                            ...
                            <div class="d-flex w-100">
                                <input type="number" class="form-control form-control-sm me-2" name="exp_from" value="{{old('exp_from')}}" placeholder="From" min="0" required>
                                @error('exp_from')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                <input type="number" class="form-control form-control-sm" name="exp_to" value="{{old('exp_to')}}" placeholder="To" min="0" required>
                                 @error('exp_to')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            ...
                            <select  class="form-select js-example-basic-multiple" multiple="multiple" name="skill_sets[]" required>
                                ...
                                <option value="{{$skill->id}}" {{old('skill_sets') && in_array($skill->id, old('skill_sets')) ? 'selected' : ''}}>{{$skill->skill}}</option>
                                 @endforeach
                            </select>
                            @error('skill_sets')
                            <span class="text-danger">{{$message}}</span>
