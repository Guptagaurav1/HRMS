                    ...
                    <table class="table table-bordered table-hover digi-dataTable all-employee-table table-striped" id="allEmployeeTable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-nowrap text-center">
                                    <a href="{{'view-letter'}}">
                                        <button class="btn btn-sm btn-primary">View Receipt <i class="fa-solid fa-file"></i></button>
                                    </a>
                                    <a href="{{'view-letter'}}">
                                        <button class="btn btn-sm btn-primary">View More  <i class="fa-solid fa-eye"></i></button>
                                    </a>
                                </td>
