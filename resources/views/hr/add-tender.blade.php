                    ...
                    <div class="mt-3 px-3">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-4 col-md-4 ">
                                ...
                                <input type="text" class="form-control form-control-sm" name="bid_value"
                                    placeholder="Enter Bid Value/Estimate" required>
                            </div>
                            <div class="col-lg-4 col-md-4 ">
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm" name="Technical_qualified"
                                    placeholder="Enter Technical Qualified">
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <label class="form-label">Tender Status</label>
                                <input type="date" class="form-control form-control-sm" name="Tender_status"
