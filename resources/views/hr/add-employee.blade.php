...
<div class="dashboard-breadcrumb mb-25">
    ...
    <div class="d-flex gap-2 justify-items-center align-items-center">
        <input type="radio" class="tab-links active" id="single-entry" name="fav_language" value="HTML" data-tab="1">
...
<div class="panel">
    ...
    <div class="employee-tab">
        <ul class="d-flex align-items-center justify-content-between  flex-wrap">
            ...
            <li>
                <button type="button" class="tab-btn" id="tab5">Other Details</button>
            </li>
        </ul>
    </div>
    ...
    <div class="tab-content active" id="content1">
        <div class="row g-3">
            ...
            <div class="col-12 d-flex justify-content-end">
                ...
                <button class="btn btn-sm btn-primary" id="employee-details-btn">Save & Next <i
    ...
    <div class="tab-content" id="content2">
        <div class="row g-3">
            ...
            <div class="col-12 d-flex justify-content-between">
                <button class="btn btn-sm btn-secondary" id="previous-btn2">Previous <i
                        class="fa-solid fa-arrow-left"></i></button>
                <button class="btn btn-sm btn-primary" id="employee-details-btn2">Save & Next <i
                        class="fa-solid fa-arrow-right"></i></button>
            </div>
        </div>
    </div>
    ...
    <div class="tab-content" id="content3">
        <div class="row g-3">
            ...
            <div class="col-12 d-flex justify-content-between">
                <button class="btn btn-sm btn-secondary" id="previous-btn3">Previous <i
                        class="fa-solid fa-arrow-left"></i></button>
                <button class="btn btn-sm btn-primary" id="employee-details-btn3">Save & Next <i
                        class="fa-solid fa-arrow-right"></i></button>
            </div>
        </div>
    </div>
    ...
    <div class="tab-content" id="content4">
        <div class="row g-3">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                ...
                                <input type="number" class="form-control form-control-sm"
                                    placeholder="Enter Degree Stream">
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <label class="form-label">Mode Of Graduation</label>
                                <input type="number" class="form-control form-control-sm"
                                    placeholder="Enter Mode of Graduation">
            ...
            <div class="col-12 d-flex justify-content-between">
                <button class="btn btn-sm btn-secondary" id="previous-btn4">Previous <i
                        class="fa-solid fa-arrow-left"></i></button>
                <button class="btn btn-sm btn-primary" id="employee-details-btn4">Save & Next <i
                        class="fa-solid fa-arrow-right"></i></button>
            </div>
        </div>
    </div>
        ...
        <div class="row g-3">
            ...
            <div class="row">
                ...
                <div class="col-12 d-flex justify-content-between">
                    <button class="btn btn-sm btn-secondary" id="previous-btn4">Previous <i
                            class="fa-solid fa-arrow-left"></i></button>
                    <button class="btn btn-sm btn-primary" id="employee-details-btn4">Save <i
                            class="fa-solid fa-arrow-right"></i></button>
                </div>
            </div>
        </div>
                ...
                <div class="panel-body">
                    <div class="row g-3">
                        <div class="col-xxl-3 col-lg-8 col-sm-6">
                            <label for="formFileSm" class="form-label">Select CSV File<span class="text-danger">
                                    *</span></label>
                            <input class="form-control form-control-sm" id="formFileSm" type="file">
                        </div>
                    </div>
