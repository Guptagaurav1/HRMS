                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-6 col-lg-6 col-sm-6">
                                ...
                                <input type="text" name="address" value="{{ $organization->address }}"
                                    class="form-control form-control-sm" name="{{ old('address') }}">
                                @error('address')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-xxl-6 col-lg-6 col-sm-6 mt-2">
                                ...
                                <input type="text" name="contact" value="{{ $organization->contact }}"
                                    class="form-control form-control-sm" name="{{ old('contact') }}">
                                @error('contact')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-xxl-6 col-lg-6 col-sm-6 mt-2">
                                ...
                                <input type="text" name="email" value="{{ $organization->email }}"
                                    class="form-control form-control-sm" name="{{ old('email') }}">
                                @error('email')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
