                    ...
                    <div class="mt-3 px-3">
                        <div class="row g-3">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm " name="lead_title" placeholder="Add Lead Name" value="{{ old('lead_title') }}">
                                @error('lead_title')
                            ...
                            <div class="col-lg-4 col-md-4 ">
                                ...
                                <input type="date" class="form-control form-control-sm" value="{{ old('deadline') }}" name="deadline" required>
                                @error('deadline')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <textarea class="form-control" name="description" id="exampleTextarea" placeholder="Enter Description "> {{ old('description') }}</textarea>
                                @error('description')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 col-lg-6">
                                ...
                                <textarea class="form-control" name="remarks" id="exampleTextarea" placeholder="Enter Remarks">{{ old('remarks') }}</textarea>
                                @error('remarks')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 mt-4" style="display: {{ auth()->user()->company_id == 2 ? 'none' : 'block' }}">
                                ...
                                <select class="form-select js-example-basic-multiple" name="category_id">
                                    ...
                                    <option value="{{ $value->id }}" {{ old('category_id') == $value->id ? 'selected' : ''}}>{{ $value->category_name }}</option>
                                    @endforeach
                                </select>
                                @error('category_id')
                                <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-lg-4 col-md-4 mt-4">
                                ...
                                <select class="form-select js-example-basic-multiple" name="source_id">
                                    ...
                                    <option value="{{ $value->id }}" {{ old('source_id') == $value->id ? 'selected' : ''}}>{{ $value->source_name }}</option>
                                    @endforeach
                                </select>
                                @error('source_id')
                                <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-lg-4 col-md-4 mt-4">
                                ...
                                <select class="form-select js-example-basic-multiple" name="assign_user_id">
                                    ...
                                    <option value="{{ $value->id }}" {{ old('assign_user_id') == $value->id ? 'selected' : ''}}>{{ ucwords($value->first_name) ." ". ucwords($value->last_name) }} ({{ $value->role ? $value->role->fullname : '' }})</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="mt-3 px-3 append_add-more-items">
                        <div class="row g-3">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <input type="text" id="attach_typ" name="attach_typ[]" value="{{ old('attach_typ[]') }}" class="form-control" placeholder="Enter Attachment Type">
                                @error('attach_typ')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="mt-3 px-3 append_add-more-spoc">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm " name="contact[]" placeholder="Enter Contact" maxlength="10">
                                @error('contact')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 mt-3">
                                ...
                                <textarea class="form-control" id="exampleTextarea" placeholder="Enter Remarks" name="sp_remarks[]"></textarea>
                                @error('remarks')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
