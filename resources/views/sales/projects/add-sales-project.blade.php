                            ...
                            <div class="mt-3 px-3">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-4 col-md-4 ">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="no_of_requirement"
                                            placeholder="Enter No of Requirements">
                                    </div>
                                    <div class="col-lg-4 col-md-4 ">
                                        <label class="form-label">Project Of Duration (In Months)</label>
                                        <input type="text" class="form-control form-control-sm" name="project_duration"
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            name="per_inv_no" placeholder="Enter Performa Invoice No">
                                    </div>
                                    <div class="col-lg-4 col-md-4 ">
                            ...
                            <div class="mt-3 px-3">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-4 col-md-4 ">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="p_contact_designation"
                                            placeholder="Enter Designation">
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <label class="form-label">Email </label>
                                        <input type="text" class="form-control form-control-sm" name="p_contact_email"
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="p_contact_landline"
                            ...
                            <div class="mt-3 px-3 append_add-more-items">
                                <div class="row g-3">
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <select class="form-select js-example-basic-multiple" name="file_type[]">
