            ...
            <div class="panel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <select class="form-select" name="year" required>
                                        ...
                                        @for ($i = $joining_year; $i <= $current_year; $i++)
                ...
                <div class="row px-4 ">
                    <div class="col-md-12">
                        ...
                        <label><strong>Month: </strong><span>{{ $selected_month }}</span> </label><br>
                        @if ($slip_get)
                            <label class="mb-3"><strong>Status : </strong><span class="text-success">Salary
                                    Generated</span></label><br>
                            <div class="col-md-12 d-flex justify-content-end my-2">
                                @if (auth('employee')->user()->hasPermission('preview-salary-slip'))
                                    <a href="{{ route('preview-salary-slip', ['id' => $filter_record->emp_salary_id]) }}"
                                        class="btn btn-primary float-right">Print Salary Slip <i
