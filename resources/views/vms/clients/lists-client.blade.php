                        ...
                        <tbody>
                            @forelse ($clients as $key => $client)
                                <tr>
                                    ...
                                    <td class="rid-column">{{ $client->user->role->role_name ?? null }}</td>
                                    <td>{{ $client->user->first_name }} {{ $client->user->last_name }} /
                                        {{ $client->user->email }} /
                                        {{ $client->user->phone }}</td>
                                    <td class="attributes-column">{{ date('jS F, Y', strtotime($client->created_at)) }}</td>
                                    <td>{{ date('jS F, Y', strtotime($client->updated_at)) }}</td>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-danger delete" data-id="{{ $client->id }}"
...
@endsection
@section('script')
    <script src="{{asset('assets/js/client-list.js')}}"></script>
@endsection
