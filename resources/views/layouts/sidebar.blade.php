        ...
        <ul class="sidebar-menu scrollable">
            ...
            <li class="sidebar-item">
                ...
                <ul class="sidebar-link-group">
                    ...
                    @endif
                    @if(auth()->user()->hasPermission('position-request') || auth()->user()->hasPermission('recruitment-report') || auth()->user()->hasPermission('recruitment-list') || auth()->user()->hasPermission('addcontact-form')|| auth()->user()->hasPermission('recruitment.offerlettershared-list'))
                    <li class="sidebar-dropdown-item">
                    ...
                    @endif
                    @if(auth()->user()->hasPermission('profile.modify-profile-request') || auth()->user()->hasPermission('profile.profile-detail-request-list'))
                    <li class="sidebar-dropdown-item">
                        ...
                        <ul class="sidebar-dropdown-menu" id="ecommerceDropdown">
                            ...
                            @if(auth()->user()->hasPermission('profile.modify-profile-request'))
                                <li class="sidebar-dropdown-item"><a href="{{route('profile.modify-profile-request')}}" class="sidebar-link">Modify Profile Request</a></li>
                            @endif
                    ...
                    @endif
                    @if(auth()->user()->hasPermission('events.birthday-list') || auth()->user()->hasPermission('events.marriage-anniversary-list') || auth()->user()->hasPermission('events.work-anniversary-list'))
                        <li class="sidebar-dropdown-item">
                ...
                <ul class="sidebar-link-group">
                    ...
                    <li class="sidebar-dropdown-item">
                        ...
                        <ul class="sidebar-dropdown-menu" id="ecommerceDropdown">
                            <li class="sidebar-dropdown-item"><a href="{{route('position-request')}}" class="sidebar-link">Home</a></li>
                    ...
                    <ul class="sidebar-link-group">
                        <li class="sidebar-dropdown-item">
                            <a role="button" class="sidebar-link has-sub" data-dropdown="advanceUiDropdown"><span class="nav-icon"><i class="fa-solid fa-right-from-bracket"></i></span> <span class="sidebar-txt">Reimbursement</span></a>
                            <ul class="sidebar-dropdown-menu" id="advanceUiDropdown">
