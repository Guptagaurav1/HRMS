                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-7 bg-white">
                                ...
                                <div class="row px-4">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label mt-2 text-dark">First Name <span
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label text-dark">Total Experience <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text bg-dark-subtle fw-bold"
                                                style="font-size: 65%;" id="basic-addon2">In Years</span>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label text-dark">Skills <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label text-dark">Email <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label text-dark">Contact No. <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label text-dark">Resume <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="col-12 col-md-5 bg-white d-flex align-items-center justify-content-center py-5">
                                <img src="{{ asset('assets/images/4565.jpg') }}" alt="background_image"
                                    class="img-fluid" />
                            </div>
                            {{--
                        </div> --}}
